...
public class Method {
     ...
     * @param simple
     *     the simple parser {method}
     * @param complex
     *     the complex parser {method:arguments}
     * @param splitter
     *     how to split the arguments
     */
     ...
     *     the complex function
     * @param split
     *     if true, will split on pipe characters (|)
     */
    public Method(String name, ParseBiFunction complex, boolean split) {
        this(name, null, complex, split ? new String[0] : null);
    }
     ...
     *     if the function throws a ParseException
     */
